        ...
        <?php require_once('vue/navbar.php'); ?>
            ...
            <section id="bienvenue">
                <div>
                    ...
                    <p>Vous pouvez envoyer vos images sur ce site pour les partager. Un lien direct vous est donné à l'issue de l'upload.
                        <br> Dans la limite de 10 Mo, les formats JPEG, JPG, PNG, BMP, et GIF sont acceptés.</p>
                    <div id="button_div"><a class="button" id="start_upload" href="index.php?p=upload">Démarrer l'envoi</a>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OU&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><a class="button" id="discover" href="#section_dernieres_images">Découvrir les 5 dernières images uploadées</a></div>
                </div>
            </section>
    </div>

    <section id="section_dernieres_images">
        <?php if (count($images) > 0) echo '<h2>Les 5 dernières images uploadées</h2>'; ?>
