    ...
    <form method="post" id="msform" >
        <fieldset>
            <h2>Votre Compte</h2>
                ...
                <a href="https://fr.gravatar.com/gravatars/new" class="button"><p>Modifier votre avatar</p></a>
                ...
                <a href="index.php?p=desactiveruser" class="button">Désactiver votre compte</a>
        </fieldset>
    </form>
